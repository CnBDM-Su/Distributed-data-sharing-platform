App = {
    ...
    publish: async function () {
        ...
        $("#tip").html('<span style="color:blue">Uploading...</span>');
...
$(function () {
    ...
    $("[name^='intro']").keyup(function () {
        ...
        if (num > 0) {
            $(this).next('span').html('remain' + num + 'words');
        } else {
            $(this).next('span').html('remain 0 word');
    ...
    $("#form").validate({
        ...
        messages: {
            nameWriter: {
                required: "×",
                rangelength: "range of words[1-50]"
            },
            style: {
                required: "×"
            },
            ...
            intro: {
                required: "×",
                rangelength: "range of words[1-1000]"
            },
            cover: {
                required: "×"
            }
